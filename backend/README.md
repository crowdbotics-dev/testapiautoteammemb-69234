...
## Project Structure
    ...
    ├── testapiautoteammemb_69234  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_69234`
...
2. Clone this repo and `cd testapiautoteammemb_69234`
